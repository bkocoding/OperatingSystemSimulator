...
public sealed partial class HorizonMusicPage : UserControl
{
    ...
    private NetCoreAudio.Player? _linuxPlayer;
    ...
    private float Volume
    {
        ...
        set
        {
            ...
            else
            {
                ...
                {
                    _linuxPlayer.SetVolume((byte)(value * 100));
                }
            }
        }
    }
    ...
    public async void StopButton_Click(object? sender, RoutedEventArgs? e)
    {
        ...
        if (_waveOut != null || _linuxPlayer != null)
        {
    ...
    private async void PlayButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        try
        {
            ...
            else
            {
                if (_linuxPlayer == null)
                {
                    _linuxPlayer = new NetCoreAudio.Player();
                }

                if (_linuxPlayer.Paused)
                {
                    _linuxPlayer.Resume().Wait();
                }
                else
                {
                    _linuxPlayer.Play(musicPath).Wait();
                    _linuxPlayer.SetVolume((byte)(Volume * 100));
                }
            }
